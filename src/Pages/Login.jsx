...
const Login = () => {
    ...
    console.log(otp);
      ...
      confirmationResult
        ...
        //     })
            ...
            //   }
        //};
          Axios.post("http://localhost:3001/sql_login", {
           number : number
          }).then((response) => {
            console.log(response);
          }, (error) => {
  ...
  return !loginStatus ? (
    <div className="w-full h-screen flex bg-gradient-to-tr from-yellow-200 via-green-200 to-green-500">
      <div className="grid grid-cols-1 md:grid-cols-2 m-auto h-[550px] shadow-lg shadow-gray-600 sm:max-w-[900px] bg-white">
        <div className="w-full h-[550px] hidden md:block">
          <img className="w-full h-full" src={peacock} alt="/" />
        </div>
